...
2. [phase2-policies](phase2-policies/CLAUDE.md) — admission/ordering scheduler + policy comparison · TODO
3. [phase3-model](phase3-model/CLAUDE.md) — queueing model + validation · TODO
